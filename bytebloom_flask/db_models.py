...
app.config['UPLOAD_FOLDER'] = './static/images/menu_foods'
...
def populate_users():
    ...
    bread = MenuItem(name='Bread (1 loaf)', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\bread.jpg')
    baguette = MenuItem(name='baguette', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\baguette.jpg')
    cupcake = MenuItem(name='cupcake', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\cupcake.jpg')
    cookie = MenuItem(name='cookie', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\cookie.jpg')
    croissant = MenuItem(name='croissant', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\croissant.jpg')
    bagel = MenuItem(name='bagel', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\bagel.jpg')
    doughnut = MenuItem(name='doughnut', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\doughnut.jpg')
    pretzel = MenuItem(name='pretzel', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\pretzel.jpg')
    pound_cake = MenuItem(name='pound cake', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\poundcake.jpg')
    brioche = MenuItem(name='brioche', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\brioche.jpg')
    banana_bread = MenuItem(name='banana bread', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\bananabread.jpg')
    macaroon = MenuItem(name='macaroon', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\macaroon.jpg')
    white_bread = MenuItem(name='white bread', price=2.99, image_path='\CodingCapstone\CapstoneProject\bytebloom_flask\static\images\menu_foods\whitebread.jpg')
