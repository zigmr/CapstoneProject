...
def populate_users():
    ...
    bread = MenuItem(name='Bread (1 loaf)', price=2.99, image_path='bread_image.jpg')
    baguette = MenuItem(name='baguette', price=2.99, image_path='bread_image.jpg')
    cupcake = MenuItem(name='cupcake', price=2.99, image_path='bread_image.jpg')
    cookie = MenuItem(name='cookie', price=2.99, image_path='bread_image.jpg')
    croissant = MenuItem(name='croissant', price=2.99, image_path='bread_image.jpg')
    bagel = MenuItem(name='bagel', price=2.99, image_path='bread_image.jpg')
    doughnut = MenuItem(name='doughnut', price=2.99, image_path='bread_image.jpg')
    pretzel = MenuItem(name='pretzel', price=2.99, image_path='bread_image.jpg')
    pound_cake = MenuItem(name='pound cake', price=2.99, image_path='bread_image.jpg')
    brioche = MenuItem(name='brioche', price=2.99, image_path='bread_image.jpg')
    banana_bread = MenuItem(name='banana bread', price=2.99, image_path='bread_image.jpg')
    macaroon = MenuItem(name='macaroon', price=2.99, image_path='bread_image.jpg')
    white_bread = MenuItem(name='white bread', price=2.99, image_path='bread_image.jpg')
